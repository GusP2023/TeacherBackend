...
PERMISSION_DEFAULTS: dict[str, dict[str, bool]] = {
    ...
    "org_admin": {
        ...
        "students.manage_enrollment":     True,
        "classes.mark_attendance":        True,
        "classes.create_recovery":        True,
        "classes.delete":                 True,
        "finances.view_own":              True,
        "finances.view_all":              True,
        "finances.manage_billing":        True,
        "finances.manage_payroll":        True,
        "finances.manage_expenses":       True,
        "finances.manage_accounts":       True,
        "finances.manage_discounts":      True,
    ...
    "teacher": {
        ...
        "students.manage_enrollment":     False,
        "classes.mark_attendance":        True,
        "classes.create_recovery":        True,
        "classes.delete":                 False,
        "finances.view_own":              True,
        "finances.view_all":              False,
        "finances.manage_billing":        False,
        "finances.manage_payroll":        False,
        "finances.manage_expenses":       False,
        "finances.manage_accounts":       False,
        "finances.manage_discounts":      False,
